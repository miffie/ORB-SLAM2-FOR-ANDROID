...
import com.example.orb_slam2_android.nativefunc.OrbNdkHelper;
					...
					new Thread(new Runnable() {
						...
						public void run() {
							while(isSLAMRunning){
								...
								// TODO Auto-generated method stub
								int[] resultInt;
								synchronized (ORBSLAMForCameraActivity.this) {
									resultInt = OrbNdkHelper.startCurrentORBForCamera(timestamp, addr, w, h);
								}
								final Bitmap img = Bitmap.createBitmap(w, h,
										Config.RGB_565);
								img.setPixels(resultInt, 0, w, 0, 0, w, h);
								runOnUiThread(new Runnable() {
									@Override
									public void run() {
										// TODO Auto-generated method stub
										imgDealed.setImageBitmap(img);
										if(resultImg != null){
											resultImg.recycle();
										}
										resultImg = img;
